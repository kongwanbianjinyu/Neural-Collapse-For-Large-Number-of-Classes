...
class ResNext(nn.Module):
    ...
    def __init__(self, block, num_blocks, feature_dim=10):
        super().__init__()
        self.in_channels = 64
        ...
        self.fc = nn.Linear(512 * 4, feature_dim)
...
def resnext50(feature_dim):
    """ return a resnext50(c32x4d) network
    """
    return ResNext(ResNextBottleNeckC, [3, 4, 6, 3], feature_dim = feature_dim)

def resnext101(feature_dim):
    """ return a resnext101(c32x4d) network
    """
    return ResNext(ResNextBottleNeckC, [3, 4, 23, 3], feature_dim = feature_dim)

def resnext152(feature_dim):
    """ return a resnext101(c32x4d) network
    """
    return ResNext(ResNextBottleNeckC, [3, 4, 36, 3], feature_dim = feature_dim)
